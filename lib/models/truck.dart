...
class Truck extends Vehicle {
  ...
  set freeWeight(dynamic value) =>
      _freeWeight = (value is int) ? value.toDouble() : (value ?? 0.0);

  double get fullWeight => _fullWeight;
  set fullWeight(dynamic value) =>
      _fullWeight = (value is int) ? value.toDouble() : (value ?? 0.0);
