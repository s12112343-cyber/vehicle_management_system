...
class _MotorcycleScreenState extends State<MotorcycleScreen> {
  ...
  List<Motorcycle> get filteredMotorcycles {
    if (_searchController.text.isEmpty) return vehicleBloc.motorcycles;
    return vehicleBloc.motorcycles.where((m) {
  ...
  void _showMotorcycleForm({Motorcycle? motorcycle, int? insertIndex}) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(motorcycle == null ? 'Add Motorcycle' : 'Edit Motorcycle'),
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (motorcycle == null) {
                ...
                if (insertIndex != null)
                  vehicleBloc.insertMotorcycle(insertIndex, newMoto);
                else
                  vehicleBloc.addMotorcycle(newMoto);
              } else {
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              vehicleBloc.deleteMotorcycle(
                                  vehicleBloc.motorcycles.indexOf(m));
